...
class FriendList(models.Model):  
    # user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="MTBuser")
    # friends = models.ManyToManyField(settings.AUTH_USER_MODEL, blank=True, related_name="MTBfriend")
